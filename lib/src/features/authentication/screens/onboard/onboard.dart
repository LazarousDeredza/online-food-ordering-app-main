...
import 'package:online_food_delivery_app/firebase_options.dart';
...
class _OnBoardState extends State<OnBoard> {
  ...
  List<OnboardModel> screens = <OnboardModel>[
    OnboardModel(
      ...
      text: "Welcome to Foodie Delight",
      desc:
    ...
    OnboardModel(
      ...
      text: "Foodie Delight, Your one stop shop for all food products",
      desc: "There is no sincerer love than the love of food. .",
      bg: const Color(0xFF4756DF),
      button: Colors.white,
    ),
    OnboardModel(
      img: 'assets/images/img-3.png',
      text: "Affordable delicious products",
      desc: "Let food be thy medicine and medicine be thy food - ...",
      bg: Colors.white,
      button: const Color(0xFF4756DF),
    ),
  ];
